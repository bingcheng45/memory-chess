...
const LOOSE_BISHOP_WHITE: PieceToken[] = ["Kg1", "Qd1", "Ra1", "Rf1", "Bc1", "Nb1", "Nf3", "a2", "b2", "f2", "g2", "h2"];
const LOOSE_BISHOP_BLACK: PieceToken[] = ["Ke8", "Ra8", "Rh8", "Bc8", "Bb4", "a7", "b7", "c7", "f7", "g7", "h7"];
