...
module.exports = {
  ...
  content: [
    ...
    // Shared layout tokens live here. Without this the class names they hold
    // are never seen by the scanner, so the rules are never generated and the
    // layout quietly loses them.
